...
**Tab: Customers**
- Row 1: `customerId`, `fullName`, `phone`, `area` (box number), `building`, `floor`, `apartmentNumber`, `subscribedAmpere`, `billingType`, `fixedDiscountAmount`, `status`, `notes`, `createdAt`, `freeReason`, `fixedDiscountPercent`, `isMonitor`, `linkedCustomerId`
